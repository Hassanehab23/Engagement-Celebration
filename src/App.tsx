        ...
        <>
          <HeroSection id="hero" isBride={isBride}>
            ...
            <div className="w-full max-w-4xl mx-auto space-y-5 sm:space-y-6 relative z-10 animate-fade-in">
              <div className="inline-flex items-center gap-2 px-3 sm:px-5 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/30 text-white text-[9px] sm:text-xs uppercase tracking-[0.15em] sm:tracking-[0.3em] max-w-full">
                ...
                <span>
                  Save The Date ({isBride ? "Bride's Invitation" : "Groom's Invitation"})
                </span>
              </div>
                      ...
                      <FadeInSection key={idx} direction="scale" delay={idx * 150}>
                        <div
                          ...
                          style={{
                            ...
                            borderColor: isBride ? 'rgba(255,182,193,0.4)' : 'rgba(212,175,55,0.3)',
                          }}
                        >
                          <span
                            className="text-3xl sm:text-5xl font-serif font-bold block mb-1"
                            style={{ color: isBride ? '#d87093' : '#1a1a1a' }}
                          >
                            {val}
                          </span>
            ...
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8">
              <FadeInSection direction="right" delay={100}>
                <LuxuryGoldCard id="location" className="flex flex-col justify-between h-full">
                  <div>
                    <div className="flex items-center gap-3 mb-5 sm:mb-6" style={{ color: isBride ? '#d87093' : '#d4af37' }}>
                      <CalendarIcon className="w-7 h-7 sm:w-8 sm:h-8 shrink-0" />
                      <h4 className="text-xl sm:text-2xl font-serif text-gray-900">Event Time</h4>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderColor: isBride ? 'rgba(255,182,193,0.3)' : 'rgba(212,175,55,0.3)',
                      }}
                    >
                    ...
                    <div className="grid grid-cols-7 gap-1 text-center text-xs sm:text-sm items-center">
                      {Array.from({ length: 30 }, (_, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className={`py-1.5 sm:py-2 transition flex items-center justify-center ${isSpecialDay ? 'font-bold scale-110' : 'text-gray-700'}`}
                          >
                            {isSpecialDay ? (
                              <div className="relative flex items-center justify-center w-7 h-7 sm:w-9 sm:h-9">
                                <Heart
                                  ...
                                  style={{ color: isBride ? '#d87093' : '#d4af37' }}
                                />
                                <span className="absolute text-[9px] sm:text-xs text-white font-bold z-10">{dayNum}</span>
                              </div>
                            ) : (
                              dayNum
                            )}
                ...
                <LuxuryGoldCard className="flex flex-col justify-between h-full">
                  <div>
                    <div className="flex items-center gap-3 mb-5 sm:mb-6" style={{ color: isBride ? '#d87093' : '#d4af37' }}>
                      ...
                      <h4 className="text-xl sm:text-2xl font-serif text-gray-900">The Venue</h4>
                    </div>
                    <div className="space-y-2 mb-6">
                      <p className="text-lg sm:text-xl font-serif font-bold text-gray-900">Nile Hall</p>
            ...
            <section id="story-timeline" className="py-12 sm:py-20 bg-white text-center">
              <div className="max-w-4xl mx-auto px-4">
                <div className="flex items-center justify-center gap-2 mb-2" style={{ color: isBride ? '#d87093' : '#d4af37' }}>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-serif text-gray-900">Dress Code Palette</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
                  <FadeInSection direction="right">
                    <div className="bg-linear-to-b from-gray-900 to-gray-950 text-white p-6 sm:p-8 rounded-3xl border border-gray-800 shadow-md relative overflow-hidden text-center h-full">
                      <div className="absolute top-0 right-0 bg-gray-800 text-gray-200 text-[9px] sm:text-[10px] tracking-widest px-3 sm:px-4 py-1 rounded-bl-xl uppercase font-bold">Gentlemen</div>
                      <h4 className="font-serif font-bold text-xl sm:text-2xl text-gray-100 mb-2">Black Gradient Suite</h4>
                      <p className="text-gray-300 text-xs sm:text-sm mb-6 font-medium">Shades of Black & Charcoal</p>
                  ...
                  <FadeInSection direction="left">
                    <div className="bg-linear-to-b from-[#fff0f5] to-white p-6 sm:p-8 rounded-3xl border border-[#ffb6c1]/50 shadow-md relative overflow-hidden text-center h-full">
                      <div className="absolute top-0 right-0 bg-[#800020] text-white text-[9px] sm:text-[10px] tracking-widest px-3 sm:px-4 py-1 rounded-bl-xl uppercase font-bold">Ladies</div>
                      <h4 className="font-serif font-bold text-xl sm:text-2xl text-[#800020] mb-2">Burgundy Gradient Palette</h4>
                      <p className="text-gray-600 text-xs sm:text-sm mb-6 font-medium">Shades of Burgundy & Deep Rose</p>
                      <div className="flex justify-center items-center gap-3 sm:gap-4 mb-4">
                        <div className="text-center">
                          <span className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#58111A] shadow-lg border-2 border-white block mx-auto mb-1" />
                          <span className="text-[9px] sm:text-[11px] text-gray-500">Deep Burgundy</span>
                        </div>
                        <div className="text-center">
                          <span className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#800020] shadow-lg border-2 border-white block mx-auto mb-1" />
                          <span className="text-[9px] sm:text-[11px] text-gray-500">Burgundy</span>
                        </div>
                        <div className="text-center">
                          <span className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#A52A2A] shadow-lg border-2 border-white block mx-auto mb-1" />
                          <span className="text-[9px] sm:text-[11px] text-gray-500">Rose Wine</span>
                        </div>
                      </div>
                    </div>
                  </FadeInSection>
          ...
          <FadeInSection direction="up">
            <section id="rsvp" className="py-12 sm:py-20 text-center" style={{ backgroundColor: theme.bgMain }}>
              <div className="max-w-xl mx-auto px-4">
                <span className="uppercase text-[10px] sm:text-xs tracking-[0.2em] sm:tracking-[0.3em] font-bold block mb-2" style={{ color: isBride ? '#d87093' : '#d4af37' }}>Be Our Guest</span>
                <h3 className="text-2xl sm:text-3xl font-serif mb-4 text-gray-900">Confirm Your Attendance</h3>
                <div className="inline-block mb-4 px-3 sm:px-4 py-1.5 rounded-full text-[10px] sm:text-xs font-semibold border max-w-full" style={{ backgroundColor: theme.cardBg, color: isBride ? '#d87093' : '#d4af37', borderColor: isBride ? '#ffb6c1' : '#d4af37' }}>
                  {isBride ? "The invitation is for: The Bride's side 👰" : "The invitation is for: The Groom's side 🤵"}
                </div>
                <p className="text-gray-500 mb-8 text-xs sm:text-sm">Enter your name and confirm via WhatsApp to notify the correct side directly.</p>
                <form
                  onSubmit={async (e) => {
                    e.preventDefault();
                    if (!guestName.trim()) {
                ...
                {rsvpStatus && (
                  <div className="mt-6 p-4 rounded-2xl border text-xs sm:text-sm font-semibold animate-fade-in" style={{ backgroundColor: theme.cardBg, color: isBride ? '#d87093' : '#333' }}>
                    {rsvpStatus}
                  </div>
                )}
              </div>
                    ...
                    wishes.map((wish, index) => (
                      <FadeInSection key={index} direction="up" delay={index * 50}>
                        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-md border" style={{ borderColor: isBride ? 'rgba(255,182,193,0.3)' : 'rgba(212,175,55,0.3)' }}>
                          ...
                          <p className="text-gray-600 text-sm leading-relaxed wrap-break-word">{wish.message}</p>
                        </div>
                      </FadeInSection>
                    ))
                  )}
            ...
            <section id="gallery" className="py-12 sm:py-20 bg-white">
              <div className="max-w-6xl mx-auto px-4 text-center">
                <div className="flex items-center justify-center gap-2 mb-2" style={{ color: isBride ? "#d87093" : "#d4af37" }}>
                  ...
                  <h3 className="text-2xl sm:text-4xl font-serif text-gray-900">Our Story in Pictures</h3>
                </div>
                <p className="text-gray-500 mb-8 sm:mb-12 text-xs sm:text-base px-2">Sweet childhood memories and wonderful moments leading to forever.</p>
                        ...
                        <div className="p-3 rounded-3xl shadow-xl border group overflow-hidden h-full flex flex-col justify-between" style={{ backgroundColor: theme.cardBg, borderColor: isBride ? "rgba(255,182,193,0.3)" : "rgba(212,175,55,0.3)" }}>
                          <div className={`overflow-hidden rounded-2xl mb-3 ${isLast ? "aspect-3/4" : ""}`}>
                            <img
                              ...
                              alt={item.caption}
                              loading="lazy"
                              className={"w-full rounded-2xl group-hover:scale-105 transition duration-700 " + (isLast ? "h-full object-cover" : "h-auto object-contain")}
                            />
                          </div>
          ...
          <footer
            ...
            style={{
              ...
              borderColor: isBride ? 'rgba(216, 112, 147, 0.2)' : 'rgba(212, 175, 55, 0.2)',
          ...
          >
            <div className="max-w-4xl mx-auto px-4 flex flex-col items-center justify-center space-y-5 sm:space-y-6">
              <div className="flex items-center justify-center gap-3 sm:gap-4">
                <span className="h-px w-8 sm:w-12" style={{ backgroundColor: isBride ? '#d87093' : '#d4af37' }} />
                <div className="p-2 sm:p-3 rounded-full shadow-md border" style={{ backgroundColor: isBride ? '#ffffff' : '#1a1a1a', borderColor: isBride ? 'rgba(216, 112, 147, 0.3)' : 'rgba(212, 175, 55, 0.3)' }}>
                  <Heart className="w-4 h-4 sm:w-5 sm:h-5 fill-current animate-pulse" style={{ color: isBride ? '#d87093' : '#d4af37' }} />
                </div>
                <span className="h-px w-8 sm:w-12" style={{ backgroundColor: isBride ? '#d87093' : '#d4af37' }} />
              </div>
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif tracking-wide mb-2" style={{ color: isBride ? '#501525' : '#ffffff' }}>
                  <span style={{ color: isBride ? '#d87093' : '#d4af37' }}>Mohamed</span>
                  {' & '}
                  <span style={{ color: isBride ? '#d87093' : '#d4af37' }}>Nada</span>
                </h2>
              </div>
